...
shell("rm -rf _master/copy_this/modules/vt-productlists/*");
console.log("");
...
process.on('exit', function (code) {
    ...
    shell("cp -r _module _master/copy_this/modules/vt-productlists");
    shell("rm -rf _master/copy_this/modules/vt-productlists/.git");
